        ...
        const buttons = (
            <Fade  {...{timeout: {enter: 2500, exit: 1000}}} in={true} mountOnEnter unmountOnExit>
                <div className="container">
                    <Button variant="outlined" component="span" className={"teamText"} onClick={this.selectXButtonClick}
                            style={{margin: 10}}>
                        Team X
                    </Button>
                    <Button variant="outlined" component="span" className={"teamText"} onClick={this.selectOButtonClick}
                            style={{margin: 10}}>
                        Team O
                    </Button>
                </div>
